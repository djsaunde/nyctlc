...
def load_file(color: str, month: int, year: int) -> dask.dataframe.DataFrame:
    # language=rst
    """
    ...
    try:
        if color == 'green':
            ...
            raise NotImplementedError('Currently, only loading of yellow and green taxi data files is supported.')
    except HTTPError:
